...
if [ $# -lt 1 ]; then
  ...
  #echo $myFreq
  #for myFreq in "800MHz" "1600MHz" "2400MHz" "3200MHz"
  ...
  #sudo cpupower -c all frequency-set -d 4000MHz -u 4000MHz
    ...
    do
      ...
      ./my_launch_files/hoGAZa/launch_calls_euroc.sh MH01 $nTokens 8 ${1}_EP_${myFreq} #6 para sin nada, 8 para sections (solo tengo la nueva version compilada en sections)
      ./my_launch_files/hoGAZa/launch_calls_euroc.sh MH01 $nTokens 3 ${1}_FP_${myFreq}
