...
public:
    ...
    System(const string &strVocFile, const string &strSettingsFile, const eSensor sensor, const bool bUseViewer = true, const size_t grainsize = 1, const int initFr = 0, const string &strSequence = std::string());
    ...
    Sophus::SE3f TrackFrame(Frame& frame, int posicion);
